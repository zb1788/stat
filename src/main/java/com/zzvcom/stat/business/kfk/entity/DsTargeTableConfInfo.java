 ...
 * @date 2020/5/26
 */
public class DsTargeTableConfInfo  implements Serializable {
...
//    private String tabWriteModel;
    ...
    private List<DsRowRule> rowRuleList;
    ...
    public List<DsRowRule> getRowRuleList() {
        return rowRuleList;
    }

    public void setRowRuleList(List<DsRowRule> rowRuleList) {
